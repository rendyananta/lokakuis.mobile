...
import com.example.lokakuis.base.exprk.TokenType.*
import java.math.RoundingMode
import kotlin.math.pow

internal class Evaluator() : ExprVisitor<BigDecimal> {
    var mathContext: MathContext = MathContext.DECIMAL64
    ...
    override fun visitCallExpr(expr: CallExpr): BigDecimal {
        val name = expr.name
        val function = functions[name.lowercase(Locale.getDefault())] ?:
